...
export interface ApiCrowdSourcingCrowdSourcing extends Struct.SingleTypeSchema {
  ...
  attributes: {
    benefits: Schema.Attribute.Component<'crowd-sourcing-page.benefits', true>;
    caseStudies: Schema.Attribute.Component<
      'crowd-sourcing-page.case-studies',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    faqs: Schema.Attribute.Component<'crowd-sourcing-page.faqs', true>;
    heroBadge: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Why AXUM SEC'>;
    heroSubtitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Leverage the Expertise of a Global Network of Ethical Hackers to Fortify Your Digital Defenses'>;
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Unleashing the Power of Crowd-Sourced Cybersecurity'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::crowd-sourcing.crowd-sourcing'
    > &
      Schema.Attribute.Private;
    modelBenefits: Schema.Attribute.Component<
      'crowd-sourcing-page.model-benefits',
      true
    >;
    modelDescription: Schema.Attribute.Blocks & Schema.Attribute.Required;
    modelSubtitle: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'A revolutionary platform connecting organizations with a global network of ethical hackers'>;
    modelTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'What is AXUM Crowd Sourcing?'>;
    overviewCrowdSourcing: Schema.Attribute.Component<
      'crowd-sourcing-page.overview-crowd-sourcing',
      true
    > &
      Schema.Attribute.Required;
    overviewDescription: Schema.Attribute.Blocks & Schema.Attribute.Required;
    overviewTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Overview'>;
    overviewTraditionalSecurity: Schema.Attribute.Component<
      'crowd-sourcing-page.overview-traditional-security',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    steps: Schema.Attribute.Component<'crowd-sourcing-page.steps', true>;
    testimonials: Schema.Attribute.Component<
      'crowd-sourcing-page.testimonials',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
